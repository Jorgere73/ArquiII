...
int main(int argc, char *argv[]){
    ...
    for(int i = 1; i < argc;)
    {
        tiempos_ejecucion = strtol(argv[i], &fin, 10);
        ...
        else if(*fin == '\0' && tiempos_ejecucion > 0)
        {
            ...
            tiemposEjec_Hijos[contadorTiempos] = tiempos_ejecucion;
            printf("%d\n", tiemposEjec_Hijos[contadorTiempos]);
            contadorTiempos++;
            i++;
        }
        else if(*fin != '\0' || tiempos_ejecucion < 0){
